...
**To claim a slot:** [open the claim form](../../issues/new?template=claim-readings.yml) — pick your week, submit, and a bot will write your name below within a minute (or tell you the day is full).

| Date | Topic | Slot 1 | Slot 2 |
|------|-------|--------|--------|
| 09/01 | Making and Visualizing Networks with R | OPEN | OPEN |
| 09/08 | Centrality | OPEN | OPEN |
| 09/15 | Reciprocity and Transitivity | Test Reader (@bdesmarais) — Dorff & Ward 2013 | OPEN |
